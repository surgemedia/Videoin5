	<header id="vidbg">
		...
		<!-- nav>li*3>a -->
		<div class="center">
			<h1 class="logo fadeInDown wow" data-wow-duration="2s" style="margin:auto;">
				<img src="img/logov5.svg" alt="">
            ...
            <ul id="simplemessage">
                ...
                <!-- <li class="wow flipInX" data-wow-delay="2s" data-wow-duration="2s" >
                <i class="simple2 "></i>
                <small>Simple</small>
                </li> -->
            </ul>
    <a class="ghost_button" href="index.php" style="margin:20px auto;">Start Upload</a>
		</div>
