		...
		<body>
			<header id='vidbg'>
				...
				<div class="center">
					...
					<span ><a href="https://www.surgemedia.com.au" target="_blank">by Surge Media</a></span> <i class="surgelogo"></i>
					</small>
					<ul id="simplemessage">
						<li class="wow flipInX" data-wow-duration="2s">
							<i class="video "></i>
							<small>You Shoot it,</small>
						</li>
					...
					<li><a class="ghost_button2" href="#app">Get Started</a></li><!--<li><a class="ghost_button2" href="#">Examples</a></li>-->
                    </ul>
					<?php
if ($_GET['error'] == 2) {
    echo '  <br />
...
?>
		...
		<section id="main" class=" wowd fadeInDown blockwidth grid">
			...
			<div id="faq" class="container mcenter">
				...
				<div class="columns sixteen">
					<h2>V5 Explained</h2>
					<iframe class="" width="49%" height="250" src="//www.youtube.com/embed/X3R2drQnLoU?showinfo=0&controls=0&rel=0" frameborder="0" allowfullscreen></iframe>
                    <iframe class="" width="49%" height="250" src="//www.youtube.com/embed/1CDqKS2JR1M?showinfo=0&controls=0&rel=0" frameborder="0" allowfullscreen></iframe>
				</div>
					...
					<ul >
						<li id="step_1" class="container form_step current">
							...
							<p class="green_com text_center"><i class="fa fa-thumbs-up"></i> If you already have, Great! <strong>Press the big'ol NEXT button below</strong></p>
								...
								Here is the fun part! You get to choose the animation you want on your logo or text logo (if you don’t have a logo). This animation can say a lot about your company so take your time. To continue just click the animation you like and Press Next.
	...
	<li id="step_4" class="container form_step">
        ...
        <div class="dialog2">
            ...
            <p><i class="fa fa-info-circle"></i> Thank you for your purchase, your video is being uploaded! <br>Please be Patient.</p>
            <p>Depending on the size of your video and the speed of your internet, the upload may take a while and in some cases up to an hour.<br>
			Sit tight, make a tea and your video will be uploaded in no time.
            </p>
           <div class="progress">  
             <div class="bar"></div >  
